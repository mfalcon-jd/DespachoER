...
public class NotaPagoViewer extends JFrame
{
     ...
     */
    static NotaPagoViewer showViewerFrame () 
    {
    	NotaPagoViewer viewerFrame = new NotaPagoViewer();
    ...
    {
    	NotaPagoViewer viewerFrame = showViewerFrame ();
    ...
    private boolean showReport () 
    {
        ...
        catch (ReportSDKException e)
        {
            ...
            JOptionPane.showMessageDialog (NotaPagoViewer.this, message, title, JOptionPane.WARNING_MESSAGE);
        }
        return false;
    }
   ...
   public void printReport()
   {
    ...
    {
    	CRJavaHelper.passResult(reportClientDocument, guiPagos.res);    	
    }     
    ...
    {      	    	    	        
	    CRJavaHelper.addDiscreteParameterValue(reportClientDocument, "", "?importeRecibido", guiPagos.importePagado);
	    CRJavaHelper.addDiscreteParameterValue(reportClientDocument, "", "?cambio", guiPagos.cambio);
	    System.out.println("IMPORTE RECIBIDO: " + guiPagos.importePagado);
	    System.out.println("CAMIO: " + guiPagos.cambio);
    }
