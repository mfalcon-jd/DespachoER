...
{
    public static final String FRAME_TITLE = "Datos Clientes";
        ...
        if (reportClientDocument == null) 
        {
           ...
           /* JFileChooser fileChooser = new JFileChooser();
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
        	   ...
        	   String reportFilePath = "Imprimir/Clientes.rpt";
    ...
    private void setResultReporte () throws ReportSDKException
    {
    	...
    	CRJavaHelper.passResult(reportClientDocument, frmClientes.res);
