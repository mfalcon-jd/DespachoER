...
public class TramitesViewer extends JFrame
{
    public static final String FRAME_TITLE = "Tramites";
     ...
     */
    static TramitesViewer showViewerFrame () 
    {
    	TramitesViewer viewerFrame = new TramitesViewer();
    ...
    {
    	TramitesViewer viewerFrame = showViewerFrame ();
    ...
    private boolean showReport () 
    {
        ...
        catch (ReportSDKException e)
        {
            ...
            JOptionPane.showMessageDialog (TramitesViewer.this, message, title, JOptionPane.WARNING_MESSAGE);
        }
        return false;
    }
    ...
    private void loadReport () throws ReportSDKException
    {
        if (reportClientDocument == null) 
        {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
        	   ...
        	   String reportFilePath = "Imprimir/TramitesCliente.rpt";
