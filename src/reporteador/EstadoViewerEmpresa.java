...
public class EstadoViewerEmpresa extends JFrame
{
    public static final String FRAME_TITLE = "Estado de Cuenta Empresa";
     ...
     */
    static EstadoViewerEmpresa showViewerFrame () 
    {
    	EstadoViewerEmpresa viewerFrame = new EstadoViewerEmpresa();
    ...
    {
    	EstadoViewerEmpresa viewerFrame = showViewerFrame ();
    ...
    private boolean showReport () 
    {
        try
        {
            ...
            if (reportClientDocument != null) {
                ...
                setReportSource ();                
                System.out.println("Conexion Base de datos");
                return true;
            }
        }
        catch (ReportSDKException e)
        {
            ...
            JOptionPane.showMessageDialog (EstadoViewerEmpresa.this, message, title, JOptionPane.WARNING_MESSAGE);
        }
        return false;
    }
    ...
    private void loadReport () throws ReportSDKException
    {
        if (reportClientDocument == null) 
        {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
        	   ...
        	   String reportFilePath = "Imprimir/estadoCuentaEmpresa.rpt";
