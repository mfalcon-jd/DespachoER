...
public class CasosViewer extends JFrame
{
    public static final String FRAME_TITLE = "Casos";
     ...
     */
    static CasosViewer showViewerFrame () 
    {
    	CasosViewer viewerFrame = new CasosViewer();
    ...
    {    	
    	CasosViewer viewerFrame = showViewerFrame ();
    	viewerFrame.showReport();
    ...
    private boolean showReport () 
    {
        ...
        catch (ReportSDKException e)
        {
            ...
            JOptionPane.showMessageDialog (CasosViewer.this, message, title, JOptionPane.WARNING_MESSAGE);
        }
        return false;
    }
    
    public static void printReport() throws ReportSDKException
    {
    	loadReport();
    	CRJavaHelper.printToServer(reportClientDocument, "HP Deskjet 6500 Series");		
    }
        ...
        if (reportClientDocument == null) 
        {
           ...
           /* JFileChooser fileChooser = new JFileChooser();
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
        	   ...
        	   String reportFilePath = "Imprimir/Casos.rpt";
    ...
    */
	...
	//MARY PASAR PARAMETROS PARA PODER ELEGIR OTROS TIPOS DE CONFIGURACIONES
    	//CRJavaHelper.addDiscreteParameterValue(reportClientDocument, "", "?idCliente", principal.curp);
    	//System.out.println("valor 1: " + principal.curp);    	
    }
