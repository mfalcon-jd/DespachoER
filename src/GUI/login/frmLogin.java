			...
			new ActionListener()
			{
				...
				public void actionPerformed(ActionEvent evento)
				{
					...
					if(usuario.length() == 0 && clave.length() == 0)
						JOptionPane.showMessageDialog( frmLogin.this,"Debe Proporcionar usuario y Contrase�a", "Error Loguin",JOptionPane.INFORMATION_MESSAGE );
						...
						JOptionPane.showMessageDialog( frmLogin.this,"Debe Proporcionar Contrase�a", "Error Loguin",JOptionPane.INFORMATION_MESSAGE );
					else
					{
						try {
	...
	public void actionPerformed(ActionEvent arg0) 
	{
		...
		if(arg0.getSource() == btnAceptar)
		{
			...
			else
			{
				...
				{
					JOptionPane.showMessageDialog( frmLogin.this,
							"Usuario o contrase�a incorrecto " + e.getMessage(),
							"Error de Loguin", JOptionPane.ERROR_MESSAGE );
				}						
			}	
		}
